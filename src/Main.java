...
public class Main {
    ...
    static class HandFactory {
        public Hand getHand(Card[] cards, int rank) {
            ...
            } else if (isFullHouse(amountPerCharacter)) {
                return new FullHouse(cards, rank);
            } else if (isThreeOfAKind(amountPerCharacter)) {
                return new ThreeOfAKind(cards, rank);
            } else if (isTwoPair(amountPerCharacter)) {
                return new TwoPair(cards, rank);
            } else if (isOnePair(amountPerCharacter)) {
